...
${buildTypeForReadme} build files. A simple RestApplication.java file is generated for you to start 
...
<#if buildType == "gradle">
2) Open a command line session, navigate to the installation directory, and run `./gradlew libertyDev` (Linux/Mac) or `gradlew libertyDev` (Windows)
...
For information on developing your application in dev mode using ${buildTypeForReadme}, see the 
