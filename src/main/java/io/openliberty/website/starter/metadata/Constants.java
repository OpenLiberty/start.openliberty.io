...
public class Constants {
    ...
    public static final String[] SUPPORTED_JAKARTAEE_VERSIONS = new String[] { "None", "7.0.0", "8.0", "9.1", "10.0" };

    public static final String[] SUPPORTED_MICROPROFILE_VERSIONS = 
        new String[] { "None", "1.4", "2.2", "3.3", "4.1", "5.0", "6.0", "6.1" };

    public static final JsonObject JAKARTA_EE_MICROPROFILE_COMPATIBILITIES = Json.createObjectBuilder()
            .add("None", Json.createObjectBuilder().add("m", Json.createArrayBuilder().add("1.4").add("2.2").add("3.3").add("4.1").add("5.0").add("6.0").add("6.1")))
            .add("7.0.0", Json.createObjectBuilder().add("m", Json.createArrayBuilder().add("None").add("1.4")))
            ...
            .add("10.0", Json.createObjectBuilder().add("m", Json.createArrayBuilder().add("None").add("6.0").add("6.1")))
            .build();
}
