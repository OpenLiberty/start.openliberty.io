...
public class StartResource extends Application {
	...
	public Response createAppZip(@Context HttpServletRequest req,
	        ...
	        @QueryParam("g") @Pattern(regexp = "[a-z]+(\\.[A-Za-z]\\w*)+", message = "Group name first package allows a-z only, subpackages also allow A-Z, 0-9 and underscores. All packages are separated by periods.") @Parameter(description = "Base Package") String groupId,
