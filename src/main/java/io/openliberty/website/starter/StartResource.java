...
public class StartResource extends Application {
	...
	public Response createAppZip(@Context HttpServletRequest req,
			...
			@QueryParam("g") @Pattern(regexp = "[A-Za-z0-9_]+(\\.[A-Za-z0-9_]*)+", message = "Group name first package allows a-z only, sub-packages also allow A-Z, 0-9 and underscores. Package names are separated by periods") @Parameter(description = "Base Package") String groupId,
